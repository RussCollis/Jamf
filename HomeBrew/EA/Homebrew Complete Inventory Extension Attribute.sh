...
: <<'SCRIPT_INFO'
=============================================================================
Homebrew Complete Inventory Extension Attribute
=============================================================================
Description:   Jamf Extension Attribute for comprehensive Homebrew inventory
               reporting. Collects all installed packages, casks, available
               updates, deprecated items, and metadata in JSON format for
               Smart Group usage and compliance reporting.

Requirements:  Homebrew installed on target systems, jq (optional - script
               has fallbacks), macOS/Linux with bash
Output:        JSON formatted data containing packages, casks, outdated items,
               deprecated items, counts, and timestamps
=============================================================================
SCRIPT_INFO
...
# Purpose: Report all Homebrew packages and casks installed on the system
# Returns: JSON formatted list of installed brew packages, casks, updates, and deprecated items
